...
function displayNext() {
  ...
  if (stateIndex == simStates.length) {
    if (okInput) result.innerHTML = '<span style="color: green;">Accept</span>';
    else result.innerHTML = '<span style="color: red;">Reject</span>';
...
class AutomaatComp extends HTMLElement {
    constructor() {
        super();
...
customElements.define('automaat-comp', AutomaatComp);
